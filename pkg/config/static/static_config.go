...
import (
	...
	acmeprovider "github.com/cgws/traefik/v2/pkg/provider/acme"
	"github.com/cgws/traefik/v2/pkg/provider/consulcatalog"
	"github.com/cgws/traefik/v2/pkg/provider/docker"
	"github.com/cgws/traefik/v2/pkg/provider/file"
	"github.com/cgws/traefik/v2/pkg/provider/kubernetes/crd"
	"github.com/cgws/traefik/v2/pkg/provider/kubernetes/ingress"
	"github.com/cgws/traefik/v2/pkg/provider/kv/consul"
	"github.com/cgws/traefik/v2/pkg/provider/kv/etcd"
	"github.com/cgws/traefik/v2/pkg/provider/kv/redis"
	"github.com/cgws/traefik/v2/pkg/provider/kv/zk"
	"github.com/cgws/traefik/v2/pkg/provider/marathon"
	"github.com/cgws/traefik/v2/pkg/provider/rancher"
	"github.com/cgws/traefik/v2/pkg/provider/rest"
	"github.com/cgws/traefik/v2/pkg/tls"
	"github.com/cgws/traefik/v2/pkg/tracing/datadog"
	"github.com/cgws/traefik/v2/pkg/tracing/elastic"
	"github.com/cgws/traefik/v2/pkg/tracing/haystack"
	"github.com/cgws/traefik/v2/pkg/tracing/instana"
	"github.com/cgws/traefik/v2/pkg/tracing/jaeger"
	"github.com/cgws/traefik/v2/pkg/tracing/zipkin"
